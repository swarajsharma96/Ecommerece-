                ...
                <div class="col-12 bg-dark py-2 d-md-block d-none">
                    <div class="row">
                        <div class="col-auto mr-auto">
                            <ul class="top-nav">
                                <li>
                                    <a href="Contact"><i class="fa fa-phone-square mr-2"></i>+8801998660240</a>
                                </li>
                                <li>
                        ...
                        <div class="col-auto">
                            <ul class="top-nav">
                                <li>
                                    <a href="sign-up.php"><i class="fas fa-user-edit mr-2"></i>Register</a>
                                </li>
                                <li>
                    ...
                    <div class="row">
                        <div class="col-lg-auto">
                            <div class="site-logo text-center text-lg-left">
                                <a href="../../public/home.php" class="site-logo " >BITM <br> PROJECT </br></a>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-4 item-photo">
                    <img style="max-width:100%;" src="images/image-1.jpg">
                </div>
                <div class="col-xs-5" style="border:0px solid gray">
                    <h3>Sony Alpha DSLR Camera</h3>
                    <h5 style="color:#337ab7">Review <a href="#">SONY</a> · <small style="color:#337ab7">(5054 votes)</small></h5>
                    ...
                    <div class="section" style="padding-bottom:20px;">
                        <h6 class="title-attr"><small>Add Cart</small></h6>
                        <div>
                    ...
                    <div class="section" style="padding-bottom:20px;">
                        <button class="btn btn-success"><span style="margin-right:20px" class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Purchase</button>
                        <h6><a href="#"><span class="glyphicon glyphicon-heart-empty" style="cursor:pointer;"></span> Make sure to click Purchase Button</a></h6>
                    </div>
                </div>
                ...
                <div class="col-xs-9">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab"> <div style="width:100%;border-top:1px solid silver">
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"> <div style="width:100%;border-top:1px solid silver">
                            <p style="padding:15px;">
                                <small class="lead">
                                    Stay connected either on the phone or the Web with the Galaxy S4 I337 from Samsung. With 16 GB of memory and a 4G connection, this phone stores precious photos and video and lets you upload them to a cloud or social network at blinding-fast speed. With a 17-hour operating life from one charge, this phone allows you keep in touch even on the go.
                        ...
                        <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab"> <div style="width:100%;border-top:1px solid silver">
                            <p style="padding:15px;">
                                <small class="lead">
                                    Stay connected either on the phone or the Web with the Galaxy S4 I337 from Samsung. With 16 GB of memory and a 4G connection, this phone stores precious photos and video and lets you upload them to a cloud or social network at blinding-fast speed. With a 17-hour operating life from one charge, this phone allows you keep in touch even on the go.
                ...
                <div class=" col-12 row text-center text-xs-center text-sm-left text-md-left">
                    <div class="col-xs-12 col-sm-4 col-md-4">
                        ...
                        <ul class="list-unstyled quick-links">
                            <li><a href="../../public/home.php"><i class="fa fa-angle-double-right"></i>Home</a></li>
