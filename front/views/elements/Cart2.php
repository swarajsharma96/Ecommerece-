        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-4 item-photo">
                    <img style="max-width:100%;" src="images/image-2.jpg">
                </div>
                <div class="col-xs-5" style="border:0px solid gray">
                    <h3>Optoma 4K HDR Projector</h3>
                    <h5 style="color:#337ab7">Review <a href="">Optoma 4K HDR Projector</a> · <small style="color:#337ab7">(5054 votes)</small></h5>

                    <h6 class="title-price"><small>Price</small></h6>
                    <h3 style="margin-top:0px;">$1,500</h3>

                    <div class="section">
                        <h6 class="title-attr" style="margin-top:15px;" ><small>COLOR</small></h6>
                        <div>
                            <div class="attr" style="width:25px;background:#f5f5f5;"></div>
