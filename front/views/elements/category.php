        ...
        <div class="col-12">
                                    ...
                                    <div class="col-12 bg-white text-center h-100 product-item">
                                        <div class="row h-100">
                                            <div class="col-12 p-0 mb-3">
                                                <a href="Cart.php">
                                                    <img src="../../public/images/image-1.jpg" class="img-fluid">
                                                </a>
                                            </div>
                                            <div class="col-12 mb-3">
                                                <a href="Cart.php" class="product-name">Sony Alpha DSLR Camera</a>
                                            </div>
                                            <div class="col-12 mb-3">
                                            ...
                                            <div class="col-12 mb-3 align-self-end">
                                                <a href="Cart.php" class="product-name">
                                                <button class="btn btn-outline-dark" type="button">
                                                    <i class="fas fa-cart-plus mr-2"></i>Add to cart</button>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3 col-sm-6 .col-lg-3  my-3">
                                    <div class="col-12 bg-white text-center h-100 product-item">
                                        <div class="row h-100">
                                            <div class="col-12 p-0 mb-3">
                                                <a href="Cart2.php">
                                                    <img src="../../public/images/image-2.jpg" class="img-fluid">
                                                </a>
                                            </div>
                                            <div class="col-12 mb-3">
                                                <a href="Cart2.php" class="product-name">Optoma 4K HDR Projector</a>
                                            </div>
                                            <div class="col-12 mb-3">
                                                    <span class="product-price">
                                                        $1,500
                                            ...
                                            <div class="col-12 mb-3 align-self-end">
                                                <a href="Cart2.php" class="product-name">
                                                <button class="btn btn-outline-dark" type="button">
                                                    <i class="fas fa-cart-plus mr-2"></i>Add to cart</button>
                                                </a>
                                            </div>
                                ...
                                <div class="col-md-3 col-sm-6 .col-lg-3  my-3">
                                    <div class="col-12 bg-white text-center h-100 product-item">
                                        <div class="row h-100">
                                            <div class="col-12 p-0 mb-3">
                                                <a href="#">
                                                    <img src="../../public/images/image-3.jpg" class="img-fluid">
                                                </a>
                                            </div>
                                            <div class="col-12 mb-3">
          ...
          <div class="container">
              <div class="row col-12">
                  <div class="col-lg-4 col-md-6 col-sm-8 mx-auto pagination">
