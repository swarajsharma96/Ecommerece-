                ...
                <table class="table table-bordered">
                    ...
                    ?>
                        <tr>
                            ...
                            <td> <a class="btn btn-primary" href="edit.php?id=<?= $product['id'];?>">Edit</a>   <a class="btn btn-primary" href="delete.php?id=<?=$product['id'];?>"onclick="return confirm('Are you sure want to delete?')">Delete</a>
                                <a class="btn btn-secondary" href="restore.php?id=<?=$product['id'];?>"onclick="return confirm('Are you sure wanna restore it?')">Restore</a>
                            </td>
                        </tr>
                    <?php
                    endforeach;
